...
const procedureItems = [
  ...
  },
  {
    ...
    title: "상하안검",
    description:
      "상안침 - 처진 윗눈꺼풀을 개선합니다. 늘어진 피부를 잘라내 시야 확보와 눈매 교정을 돕습니다. / 하안침 - 처진 아래눈꺼풀을 개선합니다. 불룩한 지방을 정리하고 늘어진 피부를 당겨 고정하여 노화를 개선합니다.",
    href: "#consultation",
    image: "/ai_11.png",
  },
  {
    ...
    title: "지방흡입",
    description:
      "복부, 허벅지, 팔뚝 등 지방이 과도하게 축적된 부위의 지방 세포를 직접 추출하여 사이즈를 줄이는 수술입니다. 단순히 무게를 줄이기보다 라인을 매끄럽게 다듬는 체형 교정에 가깝습니다.",
    href: "#consultation",
    image: "/ai_12.png",
  },
  {

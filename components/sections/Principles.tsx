        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="text-[0.95rem] lg:text-[1rem] text-text-sub leading-[1.9] space-y-5">
              ...
              <p>LINE 상담부터 예약·방한 안내·수술실 통역·귀국 후 경과 체크까지 일본 전담 통역이 전 과정을 담당합니다. '통역이 있는 병원'이 아닌 '끝까지 책임지는 전담 통역이 있는 병원'입니다.</p>
              <p>흉곽·피부 상태·생활 패턴을 진단해 그 사람만의 방법을 설계합니다. 대한 유방성형 연구회의 학술 근거를 바탕으로 '왜 이 환자에겐 이 방법이 최적인가'를 설명할 수 있습니다.</p>
            </div>
          </div>

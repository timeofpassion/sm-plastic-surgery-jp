...
export default function EnLatestBlog() {
  const posts = getPostsByLang('en').slice(0, 3)
      ...
      <div className="max-w-content mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-text-sub max-w-md mx-auto text-sm">
            Practical guides on breast surgery, eye procedures, and what to expect from plastic surgery in Korea.
          </p>
        </div>
